...
var revalidateHeader = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 9:
                error_1 = _c.sent();
                payload.logger.error('Revalidation error:', error_1);
                throw error_1;
            case 10: return [2 /*return*/, doc];
        }
    });
}); };
