...
var populateAuthors = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var authorDocs, _i, _c, author, authorDoc;
    var doc = _b.doc, req = _b.req, payload = _b.req.payload;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                if (!(doc === null || doc === void 0 ? void 0 : doc.authors)) return [3 /*break*/, 5];
                authorDocs = [];
                _i = 0, _c = doc.authors;
                _d.label = 1;
            case 1:
