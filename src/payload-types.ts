...
export interface Course {
  ...
  communitySupportTitle?: string | null;
  ...
  certificatePreview?: (string | null) | Media;
...
export interface CoursesSelect<T extends boolean = true> {
  ...
  targetAudienceDescription?: T;
  communitySupportTitle?: T;
  communitySupportDescription?: T;
  communitySupportLinks?:
    | T
    | {
        label?: T;
  ...
  offersCertificate?: T;
  certificateDescription?: T;
  certificatePreview?: T;
  relatedCoursesTitle?: T;
  relatedCourses?: T;
  seo?:
    | T
    | {
