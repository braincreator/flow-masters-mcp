...
export interface EcommerceEvent {
  action: 'view_item' | 'add_to_cart' | 'remove_from_cart' | 'begin_checkout' | 'purchase' | 'refund'
  items: Array<{
    id: string
    name: string
    category?: string
...
interface AnalyticsContextType {
  // Basic tracking
  trackEvent: (category: EventCategory, action: string, label?: string, value?: number, properties?: Record<string, any>) => void
  trackPageView: (path?: string, title?: string) => void
  
  // Specialized tracking
  trackEcommerce: (event: EcommerceEvent) => void
  trackUserAction: (action: string, properties?: Record<string, any>) => void
  trackContentInteraction: (contentId: string, action: string, properties?: Record<string, any>) => void
...
export function AnalyticsProvider({ children }: { children: ReactNode }) {
  ...
  const trackContentInteraction = useCallback((contentId: string, action: string, properties?: Record<string, any>) => {
