...
export interface FormContextType<T extends FieldValues = FieldValues> {
  ...
  register: (name: string, options?: { validation?: ValidationRule[] }) => {
    name: string
    value: FieldValue
  ...
  setValue: (name: string, value: FieldValue, options?: { shouldValidate?: boolean; shouldTouch?: boolean }) => void
  setValues: (values: Partial<T>, options?: { shouldValidate?: boolean; shouldTouch?: boolean }) => void
...
export function FormProvider<T extends FieldValues = FieldValues>({
  ...
  const validateField = useCallback((name: string, value: FieldValue): string | null => {
  ...
  // Register a field
  const register = useCallback((name: string, options?: { validation?: ValidationRule[] }) => {
