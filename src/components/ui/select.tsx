  ...
  <div className="relative w-full">
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-2 focus-visible:border-transparent',
        'focus:border-transparent focus:ring-0 focus:ring-offset-0',
        'hover:border-border hover:ring-0',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none border-transparent',
      ...
      'data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground data-[highlighted]:!border-transparent data-[highlighted]:!outline-none data-[highlighted]:!ring-0',
