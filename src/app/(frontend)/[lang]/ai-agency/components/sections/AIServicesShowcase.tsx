          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
              >
                ...
                <div className="flex justify-between items-center mb-6">
                  <div className={`font-bold text-lg ${service.price === 'БЕСПЛАТНО' ? 'text-green-600' : 'text-blue-600'}`}>
                    {service.price}
                  </div>
