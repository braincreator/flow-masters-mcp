...
export async function generateMetadata({ params }: { params: ServicePageParams }): Promise<Metadata> {
  try {
    ...
    const title = typeof serviceData.title === 'object' 
              ...
              <div className="border rounded-lg p-6 shadow-sm sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">{formatPrice(serviceData.price, 'USD', params.lang)}</span>
                  </div>
                  
                  {serviceData.duration && (
                    <div className="flex justify-between">
                      <span className="text-gray-600">{t('duration')}</span>
                      <span>{serviceData.duration} {t('minutes')}</span>
                    </div>
                  )}
