...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    if (pathname === '/mcp/health') {
      ...
      const result = toolDiscovery.getAllTools()
      ...
      const result = toolDiscovery.getToolByName(toolName)
